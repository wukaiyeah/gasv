...
\verb+BAMToGASV.gasvpro.in_sv_0.PR.results+ (many files)\\
\verb+BAMToGASV.gasvpro.in_sv_0.Variant.results+ (many files)\\
\verb+p_star.summary+\\
\verb+svFileList.summary+
\end{framed}
\noindent These files are the final output of the GASVPro.sh pipeline. See the GASVPro-graph and GASVPro-mcmc sections (Sections {\bf \ref{sec:gasvpro-graph}} and {\bf \ref{sec:gasvpro-mcmc}}, respectively) for details.

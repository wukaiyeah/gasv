...
#REQUIRED:
BAMFILE=$1
GASVDIR=/home/hlwang/Software/gasv/gasv-master
...
###############################
DATEPREFIX=${SAMPLE_NAME}_$(date +%F_%R)
### Check Input ###
...
if [ "$MAX_CHR_NUMBER" != "NULL" ]; then
	echo "MaxChrNumber: $MAX_CHR_NUMBER" >> $DATEPREFIX.gasvpro.in
fi
